...
public class Cinta {
    ...
    /** Devuelve la fila donde se encuentra el cabezal.  Las filas se enumeran desde el cero.
    ...
    /**Devuelve el número de celda donde se encuentra el cabezal. Las celdas se enumeran desde el 0.
    ...
    public void onComunicate(int pos, String lexema){ 
        //Overridable. Para la interfaz.       
    }
    
    /*public void comunicate(int pos, int fila, int col, String lexema){ //Usado por el Procesador de Errores.
        //onComunicate(pos, fila, col, lexema);
    }*/
